...
export function MarketBuilding({
  ...
  useEffect(() => {
    ...
    // Main market building walls - rectangular platform with back wall
    ...
    // Wood plank roof collision
    if (showRoof) {
      const roof = createRoofCollisionMesh(groupRef.current, 3.2, 2.5, totalHeight + 0.25);
      meshes.push(roof);
    }
